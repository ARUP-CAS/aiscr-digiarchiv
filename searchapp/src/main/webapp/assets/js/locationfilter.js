...
//    },
  ...
  enable: function () {
    ...
    if (this._enableButton) {
      ...
      this._enableButton.setClass('leaflet-locationfilter-on');
    }
  ...
  disable: function () {
    ...
    if (this._enableButton) {
      ...
      this._enableButton.setClass('leaflet-locationfilter');
    }
  ...
  _initializeButtonContainer: function () {
    ...
    this._buttonContainer = new L.Control.ButtonContainer({
      ...
      className: "leaflet-control-locationfilter leaflet-bar leaflet-control",
      position: this.options.buttonPosition,
      //title: that.options.enableButton.enableText
      title: "selection"
    });
