...
export class TranslateHeslar implements PipeTransform, OnDestroy {
  ...
  constructor(private translate: TranslateService, public solrService: SolrService, private _ref: ChangeDetectorRef) {

  }


  updateValue(key: string, field: string): void {
    this.value = this.solrService.getTranslation(key, field);
